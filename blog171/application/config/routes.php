...
$route['blog/edit/(:any)']      = 'blog/edit/$1';     // halaman edit blog
$route['blog/subedit/(:any)']   = 'blog/subedit/$1';  // proses edit blog
$route['blog/(:any)']           = 'blog/index/$1';    // baca blog dengan blog_id $1

$route['blog/search']           = 'blog/search';    // baca blog dengan blog_id $1
